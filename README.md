<div align="center">
  ...
  <p>
    <a href="https://github.com/Confetti3/SF4-Ember-Netplay/releases/tag/v0.9.8"><img alt="Release 0.9.8" src="https://img.shields.io/badge/release-0.9.8-e97835?style=flat-square&labelColor=242321"></a>
  ...
  <p>
    <strong><a href="https://github.com/Confetti3/SF4-Ember-Netplay/releases/download/v0.9.8/sf4-ember-netplay-0.9.8.zip">Download v0.9.8 for Windows</a></strong>
    &nbsp; · &nbsp; <a href="#get-started">Get started</a>
    &nbsp; · &nbsp; <a href="docs/guides/USER_NETPLAY.md">Player guide</a>
    &nbsp; · &nbsp; <a href="docs/release-notes/RELEASE_NOTES_v0.9.8.md">Release notes</a>
...
1. For a fresh installation, [download the complete v0.9.8 ZIP](https://github.com/Confetti3/SF4-Ember-Netplay/releases/download/v0.9.8/sf4-ember-netplay-0.9.8.zip) and its [SHA-256 checksum](https://github.com/Confetti3/SF4-Ember-Netplay/releases/download/v0.9.8/sf4-ember-netplay-0.9.8.zip.sha256). Choose a release package, not GitHub's source-code download.
