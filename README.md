<div align="center">
  ...
  <p>
    <a href="https://github.com/Confetti3/SF4-Ember-Netplay/releases/tag/v0.8.9"><img alt="Release 0.8.9" src="https://img.shields.io/badge/release-0.8.9-e97835?style=flat-square&labelColor=242321"></a>
  ...
  <p>
    <strong><a href="https://github.com/Confetti3/SF4-Ember-Netplay/releases/download/v0.8.9/sf4-ember-netplay-0.8.9.zip">Download v0.8.9 for Windows</a></strong>
    &nbsp; · &nbsp; <a href="#get-started">Get started</a>
    &nbsp; · &nbsp; <a href="docs/USER_NETPLAY.md">Player guide</a>
    &nbsp; · &nbsp; <a href="docs/RELEASE_NOTES_v0.8.9.md">Release notes</a>
  </p>
</div>
...
1. For a fresh installation, [download the complete v0.8.9 ZIP](https://github.com/Confetti3/SF4-Ember-Netplay/releases/download/v0.8.9/sf4-ember-netplay-0.8.9.zip) and its [SHA-256 checksum](https://github.com/Confetti3/SF4-Ember-Netplay/releases/download/v0.8.9/sf4-ember-netplay-0.8.9.zip.sha256). Choose a release package, not GitHub's source-code download.
