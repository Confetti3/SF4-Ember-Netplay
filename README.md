<div align="center">
  ...
  <p>
    <a href="https://github.com/Confetti3/SF4-Ember-Netplay/releases/tag/v0.9.3"><img alt="Release 0.9.3" src="https://img.shields.io/badge/release-0.9.3-e97835?style=flat-square&labelColor=242321"></a>
...
1. For a fresh installation, [download the complete v0.9.3 ZIP](https://github.com/Confetti3/SF4-Ember-Netplay/releases/download/v0.9.3/sf4-ember-netplay-0.9.3.zip) and its [SHA-256 checksum](https://github.com/Confetti3/SF4-Ember-Netplay/releases/download/v0.9.3/sf4-ember-netplay-0.9.3.zip.sha256). Choose a release package, not GitHub's source-code download.
