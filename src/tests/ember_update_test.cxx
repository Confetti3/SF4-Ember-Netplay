...
int main(int argc, char** argv) {
    ...
    auto result = ParseGithubReleaseResponse(release.dump(), "0.8.2");
    ...
    CHECK(!ParseGithubReleaseResponse(release.dump(), "0.8.2").ok);
    CHECK(!ParseGithubReleaseResponse("invalid json", "0.8.3").ok);
    CHECK(!ParseGithubReleaseResponse("{}", "0.8.3").ok);
