...
never force a seat rotation. Both fighters must ready again after returning to
...
See [CUSTOM_ROOMS_STATUS.md](CUSTOM_ROOMS_STATUS.md) for the exact build and test
