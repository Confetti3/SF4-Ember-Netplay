...
See [authorized implementation scope](../design/controller-selection-scope.md). This was a local source fix with bounded, read-only native inspection, not a security assessment.
