...
Analysis date: 8 September 2026. Tools: IDA 9.4 / Hex-Rays through the local MCP worker and existing project source. Scope: [authorized local reader discovery](../design/training-native-scope.md). Report flavor: ordinary reverse analysis; no vulnerability or threat claim.
