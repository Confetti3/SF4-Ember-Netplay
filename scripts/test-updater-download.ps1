...
param(
    [string]$Repo = "Confetti3/SF4-Ember-Netplay"
)
...
$asset = $release.assets | Where-Object { $_.name -like "sf4-ember-netplay-*.zip" } | Select-Object -First 1
if (-not $asset) {
    throw "No sf4-ember-netplay zip asset on latest release."
}
